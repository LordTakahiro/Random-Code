...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Lilith Immaculate", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Lilith Immaculate";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Lilith Immaculate", null, { width: 640, height: 480 });
