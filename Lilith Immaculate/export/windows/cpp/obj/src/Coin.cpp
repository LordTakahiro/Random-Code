...
HXLINE(  16)		this->loadGraphic(HX_("assets/images/coin.png",f7,e9,c5,54),false,(int)8,(int)8,null(),null());
            	}
...
void Coin_obj::kill(){
            	HX_STACK_FRAME("Coin","kill",0xcf15eb7b,"Coin.kill","Coin.hx",19,0x01a6c5ad)
            	HX_STACK_THIS(this)
HXLINE(  20)		this->set_alive(false);
HXLINE(  21)		Float _hx_tmp = (this->y - (int)16);
HXDLIN(  21)		::flixel::tweens::FlxTween_obj::tween(hx::ObjectPtr<OBJ_>(this), ::Dynamic(hx::Anon_obj::Create(2)
...
void Coin_obj::finishKill( ::flixel::tweens::FlxTween _){
            	HX_STACK_FRAME("Coin","finishKill",0x3e72412e,"Coin.finishKill","Coin.hx",25,0x01a6c5ad)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE(  25)		this->set_exists(false);
            	}
