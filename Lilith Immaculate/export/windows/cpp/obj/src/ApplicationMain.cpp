...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("HaxeFlixel",42,8f,0c,ac),HX_("Lilith Immaculate",c2,b9,32,b0),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
...
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)640,(int)480,(int)60,(int)0,((int)((int)_hx_tmp | (int)(int)0) | (int)(int)0),HX_("Lilith Immaculate",c2,b9,32,b0),null(),null());
            	}
