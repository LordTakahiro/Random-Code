...
HXDLIN( 167)		if ((_hx_tmp1 == HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f))) {
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.console.Console","boot",0x712d8cc8,"flixel.system.debug.console.Console.boot","flixel/system/debug/console/Console.hx",37,0x367943c8)
