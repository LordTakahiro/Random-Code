...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/TileTest.oep", "assets/data/TileTest.oep");
		type.set ("assets/data/TileTest.oep", AssetType.TEXT);
		path.set ("assets/images/77.png", "assets/images/77.png");
		type.set ("assets/images/77.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/TileTest.oep";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/77.png";
		path.set (id, id);
